...
book.save(r'C:\Users\User\Desktop\SEO\12-18\今日数据(py接口).xlsx')
app.quit()
print('今日数据获取完毕！')
...
bot_DA.send_photo(-812533282,open(r'C:\Users\User\Desktop\SEO\截图文件\shuju(12h)-3.png','rb'),timeout=100)
