...
his_data  = pd.read_excel(r'C:\Users\User\Desktop\SEO\SEO总表(12点+18点).xlsx','数据(18点)')
...
sheet_shuju = book.sheets['数据(18点)']
...
sheet2_shuju = book2.sheets['数据(18点)']
...
img_shuju.save(r'C:\Users\User\Desktop\SEO\截图文件\shuju(18h).png')  # 保存图片
# pyperclip.copy('')
# # 删除行末表头
...
bot_DA.send_photo(-812533282,open(r'C:\Users\User\Desktop\SEO\截图文件\shuju(18h).png','rb'))
bot_DA.send_message(-812533282,f'截止今日18点,   注册:  {shuju.loc["当日汇总","注册"]} ,开户:  {shuju.loc["当日汇总","开户"]}，整体'
