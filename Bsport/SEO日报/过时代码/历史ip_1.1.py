...
user = pd.read_csv(r'C:\Users\User\Desktop\SEO\_0807\会员列表导出.csv',encoding='gbk')
firChargeUser = pd.read_csv(r'C:\Users\User\Desktop\SEO\_0807\会员首存报表.csv',encoding='gbk')
data = pd.read_excel(r'C:\Users\User\Desktop\SEO\_0807\data\今日数据.xlsx')
data_2 = pd.read_excel(r'C:\Users\User\Desktop\SEO\_0807\今日数据.xlsx','趋势分析')
...
dic ={'日期':(datetime.datetime.now()+datetime.timedelta(days=-8)).strftime('%Y/%m/%d'),
...
print(df)
df.to_csv(r'C:\Users\User\Desktop\SEO\ip历史数据.csv',mode='a',index=False,header=True,encoding='gbk')