...
day = -1
user = pd.read_csv(r'C:\Users\User\Desktop\SEO\_0814\会员列表导出.csv',encoding='gbk')
firChargeUser = pd.read_csv(r'C:\Users\User\Desktop\SEO\_0814\会员首存报表.csv',encoding='gbk')
data = pd.read_excel(r'C:\Users\User\Desktop\SEO\_0814\今日数据.xlsx')
data_2 = pd.read_excel(r'C:\Users\User\Desktop\SEO\_0814\今日数据.xlsx','趋势分析')
