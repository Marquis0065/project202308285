...
shuju = shuju.merge(grpSEO,on='人员2')
...
# 第2次merge
shuju = shuju.merge(grpCHARGE,how='left',on='人员2')
...
# 第3次merge
shuju  = shuju.merge(grp3,how='left',on='人员2')
...
#
#
# shuju.loc['当日汇总','对比昨天(总IP)']=shuju['对比昨天(总IP)'].sum()
# shuju.loc['当日汇总','对比前3天均值(总IP)']=shuju['对比前3天均值(总IP)'].sum()
# shuju.loc['当日汇总','对比前5天均值(总IP)']=shuju['对比前5天均值(总IP)'].sum()
# shuju.loc['当日汇总','对比前7天均值(总IP)']=shuju['对比前7天均值(总IP)'].sum()
# shuju.loc['当日汇总','对比昨天(总注册)']=shuju['对比昨天(总注册)'].sum()
# shuju.loc['当日汇总','对比前3天均值(总注册)']=shuju['对比前3天均值(总注册)'].sum()
# shuju.loc['当日汇总','对比前5天均值(总注册)']=shuju['对比前5天均值(总注册)'].sum()
# shuju.loc['当日汇总','对比前7天均值(总注册)']=shuju['对比前7天均值(总注册)'].sum()
# shuju.loc['当日汇总','对比昨天(总开户)']=shuju['对比昨天(总开户)'].sum()
# shuju.loc['当日汇总','对比前3天均值(总开户)']=shuju['对比前3天均值(总开户)'].sum()
# shuju.loc['当日汇总','对比前5天均值(总开户)']=shuju['对比前5天均值(总开户)'].sum()
# shuju.loc['当日汇总','对比前7天均值(总开户)']=shuju['对比前7天均值(总开户)'].sum()
