...
def fun_jar():
    ...
    input[0].send_keys((datetime.datetime.now()+datetime.timedelta(days=-1)).strftime('%Y%m%d'))
    time.sleep(2)
    ...
    time.sleep(2)
    input[5].send_keys((datetime.datetime.now()+datetime.timedelta(days=-1)).strftime('%Y%m%d'))
